...
Defined in: node\_modules/@black-flag/core/dist/src/error.d.ts:137
...
Note that [CliErrorOptions.dangerouslyFatal](../type-aliases/CliErrorOptions.md#dangerouslyfatal), if given, is always
ignored.
...
Defined in: node\_modules/@black-flag/core/dist/src/error.d.ts:147
...
Defined in: node\_modules/@black-flag/core/dist/src/error.d.ts:138
